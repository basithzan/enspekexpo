...
const CerttificationForm = ({ defaultValues }) => {
  ...
  const onSubmit = (data) => {
    ...
    dispatch(
      ...
      toast.info('Certifications Updated Successfully')
  ...
  useEffect(() => {
    const initialExperiences =
      inspector?.user?.inspector_details?.certifications || [];
  ...
  return (
    <>
      ...
      {inspector_loading ? (
        ...
        <>
          <TopBar title={"Edit Certification"} show_back />
          <div className="pb-16">
              ...
              <div className="px-5 py-2">
                {experiences.map((experience, index) => (
                  <div key={index}>
                    ...
                    >
                      {parseInt(index) + 1} Certification
                    </h2>
...
export default CerttificationForm;
