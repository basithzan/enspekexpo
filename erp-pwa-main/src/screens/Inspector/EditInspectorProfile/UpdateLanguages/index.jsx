...
const LanguageForm = ({ defaultValues }) => {
  ...
  useEffect(() => {
    const initialExperiences =
      inspector?.user?.inspector_details?.languages || [];
  ...
  return (
    <>
      ...
      {inspector_loading ? (
        ...
        <>
          <TopBar title={"Edit Language"} show_back />
          <div className="pb-16">
