  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // Update AsyncStorage with new experience data
        if (refreshResponse.data.success) {
          try {
            const userData = await AsyncStorage.getItem('user_data');
            if (userData) {
              const parsedUser = JSON.parse(userData);
              // Update the inspector_details with new experience data
              if (parsedUser.inspector_details) {
                parsedUser.inspector_details.experience = formattedExperiences;
                ...
                parsedUser.details.inspector_details.experience = formattedExperiences;
              }
